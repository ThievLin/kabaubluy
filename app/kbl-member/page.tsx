...
const BecomeMemberPage = () => {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-8">
      <h1 className="text-2xl font-bold text-center mb-12">Become Our Member</h1>
      <div className="flex flex-col md:flex-row max-w-[90%] w-full mx-auto">
        <div className="flex-1 md:w-3/5 p-4 text-lg">
          <p className="mb-4">
        ...
        <form className="bg-white p-8 rounded-lg shadow-md flex-1 md:w-2/5 m-4">
